##First we set the working directory as the directory where the raw csv data is located
setwd("C:/Users/ASUS/Documents/Exeter MSc in BA Learning/Topics in Business Analytics/Assignment 2")
...
View(airbnbfinal1)
View(airdatanum2)
write_xlsx(airdatafinal1, "airbnbdata3.xlsx")
